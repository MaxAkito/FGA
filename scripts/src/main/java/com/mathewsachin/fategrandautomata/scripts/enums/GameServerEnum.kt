...
enum class GameServerEnum constructor(vararg val packageNames: String) {
    En("com.aniplex.fategrandorder.en", "com.aniplex.fategrandorder.eo", "io.rayshift.betterfgo.en"),
    Jp("com.aniplex.fategrandorder", "com.aniplex.fategrandordes", "io.rayshift.betterfgo"),
